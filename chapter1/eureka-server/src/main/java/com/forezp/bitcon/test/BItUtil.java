...
////        return Address.fromKey(params,ecKey, Script.ScriptType.P2P).toBase58().toString();
//    }
//
//
//    //通过speed 获取钱包
...
//        NetworkParameters params = getParams();
//        Address targetAddress = Address.fromString(params, recipientAddress);
...
//            return err;
//        }
//        SendRequest request = SendRequest.to(Address.fromString(params, recipientAddress), Coin.parseCoin(amount));
//        try {
...
//        Address a = Address.fromString(getParams(), recipientAddress);
...
////        NetworkParameters params = TestNet3Params.get();
////        DeterministicSeed seed = new DeterministicSeed(new SecureRandom(), 128, "123456");
////        List<String> mnemonicCode = seed.getMnemonicCode();
////        System.out.print("mnemonicCode" + mnemonicCode);
...
////        NetworkParameters params = getParams();
////        String s = ceKey.(params).toBase58().toString();
...
////            e.printStackTrace();
////        }
////        kcg =  KeyChainGroup.builder(getParams(), new KeyChainGroupStructure() {
////        })
...
//        KeyChainGroup kcg = KeyChainGroup.builder(getParams()).build();
//        Wallet wallet = new Wallet(getParams(), kcg);
...
////        WalletAppKit walletAppKit = new WalletAppKit(getParams(), context.getCacheDir(), Attribute.Constant.WALLET_NAME) {
////            @Override
...
////        SendRequest request = SendRequest.to(Address.fromString(getParams(),
